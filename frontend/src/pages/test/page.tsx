...
export default function TestPage() {
  ...
  const banner = (
    <div className="bg-primary-950 text-white p-4 md:p-5 rounded-2xl relative overflow-hidden flex flex-wrap items-center gap-4 max-w-md">
      <div className="relative z-10 min-w-0">
        ...
        <h2 className="font-heading text-base md:text-lg font-bold text-white leading-snug">{t("test.bannerTitle")}</h2>
        <p className="mt-1 text-xs text-white/70">{t("test.pickSubjectHint")}</p>
      </div>
