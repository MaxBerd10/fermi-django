...
export const announcements = [
  { id: 1, sticky: true, tag: "Muhim", date: "2026-07-05", title: "Texnikum bitiruvchilari qabul boshlandi — 5 iyul", href: "/yangiliklar/texnikum-qabul" },
...
export const events = [
  {
    ...
    day: "20",
    month: "IYUL",
    title: "Ochiq eshiklar kuni — Qabul-2026",
    desc: "Abituriyentlar va ota-onalar uchun fakultetlar, klinik baza va qabul shartlari bilan tanishish kuni. Ekspertlar savollarga javob beradi.",
    time: "10:00 – 15:00",
    place: "Bosh bino, katta zal",
    type: "Tadbir",
  },
  {
    id: 2,
...
export const galleryImages = [
  { id: 1, src: "https://readdy.ai/api/search-image?query=Beautiful%20modern%20medical%20university%20campus%20building%20facade%20with%20contemporary%20architecture%2C%20glass%20windows%20reflecting%20blue%20sky%2C%20green%20landscaped%20garden%20in%20foreground%2C%20sunny%20day%20with%20soft%20natural%20lighting%2C%20professional%20architectural%20photography%2C%20clean%20and%20prestigious%20academic%20atmosphere%2C%20no%20text%20or%20banners%20visible&width=800&height=800&seq=fjsti-gallery-1&orientation=squarish", alt: "Institut binosi" },
  { id: 2, src: "https://readdy.ai/api/search-image?query=Medical%20students%20sitting%20together%20on%20campus%20lawn%20studying%20and%20discussing%2C%20green%20grass%20and%20trees%2C%20modern%20university%20building%20in%20background%2C%20relaxed%20academic%20atmosphere%2C%20warm%20golden%20hour%20sunlight%2C%20candid%20natural%20photography%2C%20joyful%20and%20collaborative%20mood%2C%20no%20text%20or%20banners%20visible&width=800&height=800&seq=fjsti-gallery-2&orientation=squarish", alt: "Talabalar hayoti" },
  { id: 3, src: "https://readdy.ai/api/search-image?query=Modern%20medical%20laboratory%20interior%20with%20microscopes%20and%20scientific%20equipment%2C%20clean%20white%20surfaces%20and%20bright%20organized%20workspace%2C%20professional%20research%20environment%2C%20soft%20natural%20lighting%20from%20overhead%2C%20medical%20science%20photography%2C%20sterile%20and%20precise%20atmosphere%2C%20no%20text%20or%20banners%20visible&width=800&height=800&seq=fjsti-gallery-3&orientation=squarish", alt: "Laboratoriya" },
  { id: 4, src: "https://readdy.ai/api/search-image?query=Large%20university%20lecture%20hall%20with%20tiered%20seating%20filled%20with%20medical%20students%2C%20professor%20presenting%20at%20podium%20with%20projection%20screen%2C%20modern%20auditorium%20design%20with%20good%20lighting%2C%20academic%20conference%20atmosphere%2C%20professional%20educational%20photography%2C%20no%20text%20or%20banners%20visible&width=800&height=800&seq=fjsti-gallery-4&orientation=squarish", alt: "Kongress zali" },
  { id: 5, src: "https://readdy.ai/api/search-image?query=Medical%20students%20in%20white%20lab%20coats%20practicing%20clinical%20skills%20with%20medical%20mannequins%20in%20simulation%20training%20center%2C%20hands-on%20learning%20environment%2C%20modern%20medical%20training%20facility%2C%20bright%20clean%20room%20with%20medical%20equipment%2C%20professional%20healthcare%20education%20photography%2C%20no%20text%20or%20banners%20visible&width=800&height=800&seq=fjsti-gallery-5&orientation=squarish", alt: "Simulyatsiya markazi" },
  { id: 6, src: "https://readdy.ai/api/search-image?query=Medical%20university%20graduation%20ceremony%2C%20graduates%20in%20academic%20gowns%20and%20caps%20celebrating%20with%20diplomas%20in%20hand%2C%20throwing%20caps%20in%20the%20air%2C%20outdoor%20ceremony%20with%20university%20building%20in%20background%2C%20joyful%20and%20proud%20moment%2C%20bright%20sunny%20day%2C%20professional%20event%20photography%2C%20no%20text%20or%20banners%20visible&width=800&height=800&seq=fjsti-gallery-6&orientation=squarish", alt: "Bitiruv marosimi" },
];
...
export const navItems = [
  {
    ...
    children: [
      ...
      { label: "Missiya va tarix", href: "/institut#tarix" },
      { label: "Rahbariyat", href: "/institut/rahbariyat" },
      { label: "Tuzilma", href: "/institut/tuzilma" },
      { label: "Sertifikatlar", href: "/institut#sertifikatlar" },
      { label: "Xalqaro akkreditatsiya", href: "/institut#akkreditatsiya" },
      { label: "Institut binolari", href: "/institut#binolar" },
      { label: "Ilmiy kengash", href: "/institut#ilmiy-kengash" },
    ],
  },
  {
    label: "Tuzilma",
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Texnikum bitiruvchilari", href: "/qabul/texnikum" },
    ],
  },
  {
    label: "Talabalar",
    href: "/talabalar",
    children: [
      { label: "Bakalavriat", href: "/talabalar/bakalavriat" },
      { label: "Magistratura", href: "/talabalar/magistratura" },
      { label: "Ordinatura", href: "/talabalar/ordinatura" },
      { label: "Xalqaro talabalar", href: "/talabalar/xalqaro" },
      { label: "Iqtidorli talabalar", href: "/talabalar/iqtidorli" },
    ],
  },
  {
    label: "Xizmatlar",
...
export const contactInfo = {
  ...
  socials: {
    ...
    twitter: "https://x.com/fergana_medical",
    youtube: "https://youtube.com/@FJSTIOFFICIAL",
    telegram: "https://t.me/ferghana_medical_institute",
    instagram: "https://www.instagram.com/fjsti_offical_page",
  },
};
...
export const admissionInfo = {
  bakalavriat: {
    ...
    hujjatlar: [
      ...
      "11-sinf shahodatnomasi / diplom",
      "3x4 sm (6 dona) fotosurat",
      "Tibbiyot xulosasi (086-f)",
      "Onlayn ariza (my.uzedu.uz)",
    ],
  },
  magistratura: {
    kvota: "350",
